  ...
  <table class="table table-zebra table-xs w-full">
    ...
    <tbody>
      <tr>
        ...
        <td>
<label class="badge badge-error badge-sm">87.0%</label>        </td>
...
<label class="badge badge-error badge-sm">87.0%</label>        </td>
      ...
      <tr>
        ...
        <td class="text-xs font-medium">python</td>
        <td>
<label class="badge badge-error badge-sm">81.2%</label>        </td>
        <td class="text-xs">76 MB</td>
        <td class="text-xs">runner</td>
      </tr>
      <tr>
        <td class="text-xs">2332</td>
        <td class="text-xs font-medium">python</td>
        <td>
<label class="badge badge-error badge-sm">69.5%</label>        </td>
        <td class="text-xs">77 MB</td>
        <td class="text-xs">runner</td>
      </tr>
      <tr>
        ...
        <td>
<label class="badge badge-info badge-sm">11.6%</label>        </td>
