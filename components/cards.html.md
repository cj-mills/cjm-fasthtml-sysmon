...
Design improvements: - Increased gap between cores for better breathing
room - Core labels at 60% opacity instead of 40% for better
readability - Larger padding for better touch targets - Better size
progression across breakpoints

Grid columns are optimized for container width at each breakpoint: -
Mobile (1 col main): 4 cores wide - Small (1 col main): 6 cores wide -
Medium (2 col main): 4 cores wide (card is ~50% screen) - Large (2 col
main): 5 cores wide (card is ~50% screen) - XL (3 col main): 5 cores
wide (card is ~33% screen) - 2XL (3 col main): 6 cores wide (limited to
3 cols)\*
...
<span class="text-xs text-base-content/60 font-normal">C0</span>    <div class="text-xs sm:text-sm font-semibold text-success">44%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C1</span>    <div class="text-xs sm:text-sm font-semibold text-warning">63%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C2</span>    <div class="text-xs sm:text-sm font-semibold text-warning">62%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C3</span>    <div class="text-xs sm:text-sm font-semibold text-warning">65%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C4</span>    <div class="text-xs sm:text-sm font-semibold text-warning">58%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C5</span>    <div class="text-xs sm:text-sm font-semibold text-success">36%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C6</span>    <div class="text-xs sm:text-sm font-semibold text-base-content/60">4%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C7</span>    <div class="text-xs sm:text-sm font-semibold text-error">84%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C8</span>    <div class="text-xs sm:text-sm font-semibold text-error">97%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C9</span>    <div class="text-xs sm:text-sm font-semibold text-success">31%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C10</span>    <div class="text-xs sm:text-sm font-semibold text-warning">64%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C11</span>    <div class="text-xs sm:text-sm font-semibold text-error">86%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C12</span>    <div class="text-xs sm:text-sm font-semibold text-warning">77%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C13</span>    <div class="text-xs sm:text-sm font-semibold text-base-content/60">6%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C14</span>    <div class="text-xs sm:text-sm font-semibold text-warning">59%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C15</span>    <div class="text-xs sm:text-sm font-semibold text-base-content/60">8%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C16</span>    <div class="text-xs sm:text-sm font-semibold text-success">24%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C17</span>    <div class="text-xs sm:text-sm font-semibold text-success">27%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C18</span>    <div class="text-xs sm:text-sm font-semibold text-error">85%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C19</span>    <div class="text-xs sm:text-sm font-semibold text-warning">73%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C20</span>    <div class="text-xs sm:text-sm font-semibold text-success">39%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C21</span>    <div class="text-xs sm:text-sm font-semibold text-warning">78%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C22</span>    <div class="text-xs sm:text-sm font-semibold text-error">95%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C23</span>    <div class="text-xs sm:text-sm font-semibold text-error">85%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C24</span>    <div class="text-xs sm:text-sm font-semibold text-warning">52%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C25</span>    <div class="text-xs sm:text-sm font-semibold text-warning">70%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C26</span>    <div class="text-xs sm:text-sm font-semibold text-base-content/60">7%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C27</span>    <div class="text-xs sm:text-sm font-semibold text-success">38%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C28</span>    <div class="text-xs sm:text-sm font-semibold text-base-content/60">5%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C29</span>    <div class="text-xs sm:text-sm font-semibold text-error">85%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C30</span>    <div class="text-xs sm:text-sm font-semibold text-warning">53%</div>
  </div>
  <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C31</span>    <div class="text-xs sm:text-sm font-semibold text-success">29%</div>
  </div>
</div>
```
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L144"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L169"
target="_blank" style="float:right; font-size:smaller">source</a>
...
Design improvements: - Larger card title (lg font, bold) - XL badge for
percentage to make it hero element - Increased card body padding -
Better section spacing (m.b(6) instead of m.b(4)) - Section headers more
prominent\*
...
<span class="badge badge-primary badge-xl">60.0%</span>  </div>
  <div class="mb-6">
    <div>
      <div class="justify-between mb-2 flex">
<span class="text-sm font-medium text-base-content">Overall Usage</span><span class="text-xs text-base-content/70">60.0%</span>      </div>
<progress value="60.0" max="100" class="progress progress-warning w-full h-2"></progress>    </div>
  </div>
  <div class="mb-6">
    <p class="text-sm font-semibold mb-3">CPU Frequency</p>
    <div class="flex justify-between gap-2">
<span class="text-primary text-sm font-medium">Current: 3207 MHz</span><span class="text-base-content/70 text-xs">Min: 0 MHz</span><span class="text-base-content/70 text-xs">Max: 0 MHz</span>    </div>
  </div>
  <div class="mt-6">
    <p class="text-sm font-semibold mb-3">Per Core Usage</p>
    <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-6 gap-2 sm:gap-3 w-full">
      <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C0</span>        <div class="text-xs sm:text-sm font-semibold text-success">30%</div>
      </div>
      <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C1</span>        <div class="text-xs sm:text-sm font-semibold text-success">27%</div>
      </div>
      <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C2</span>        <div class="text-xs sm:text-sm font-semibold text-warning">50%</div>
      </div>
      <div class="flex flex-col items-center justify-center p-2 sm:p-3 bg-base-200 rounded-md min-w-12 sm:min-w-14 h-12 sm:h-14">
<span class="text-xs text-base-content/60 font-normal">C3</span>        <div class="text-xs sm:text-sm font-semibold text-success">40%</div>
      </div>
    </div>
  </div>
</div>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L241"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<span class="badge badge-primary badge-xl">8.3%</span>  </div>
  <div class="mb-6">
    <p class="text-sm font-semibold mb-3">RAM</p>
    <div>
      <div class="justify-between mb-2 flex">
<span class="text-sm font-medium text-base-content">1.3 GB / 15.6 GB</span><span class="text-xs text-base-content/70">8.3%</span>      </div>
<progress value="8.3" max="100" class="progress progress-success w-full h-2"></progress>    </div>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L333"
target="_blank" style="float:right; font-size:smaller">source</a>
...
*Render network interfaces with improved progress bar height and
spacing.*
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L398"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L418"
target="_blank" style="float:right; font-size:smaller">source</a>
  ...
  <div id="network-connections" class="mt-3">
    ...
    <div class="stats bg-base-200 rounded-lg p-2 text-xs overflow-x-auto w-full">
      <div class="stat">
        ...
        <div class="stat-value text-2xl font-bold text-base-content">28</div>
      </div>
      <div class="stat">
        <div class="stat-title text-xs text-base-content/60">Established</div>
        <div class="stat-value text-2xl font-bold text-base-content">10</div>
      </div>
      <div class="stat">
      ...
      <div class="stat">
        ...
        <div class="stat-value text-2xl font-bold text-base-content">9</div>
      </div>
    </div>
  </div>
</div>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L468"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<label class="badge badge-info badge-sm">0.0%</label>            </td>
          ...
          <tr>
            <td class="text-xs">244</td>
            <td class="text-xs font-medium">systemd-udevd</td>
            <td>
<label class="badge badge-info badge-sm">0.0%</label>            </td>
            <td class="text-xs">8 MB</td>
            <td class="text-xs">root</td>
          </tr>
          <tr>
            <td class="text-xs">405</td>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L522"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L646"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L665"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L703"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-sysmon/blob/main/cjm_fasthtml_sysmon/components/cards.py#L753"
target="_blank" style="float:right; font-size:smaller">source</a>
